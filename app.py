...
<div class="main-header">
    ...
    <p>Tác giả: Trần Thị Kim Oanh - Trường Tiểu học Quyết Tiến - ĐT: 097 3606 583</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Trần Thị Kim Oanh - Trường Tiểu học Quyết Tiến - ĐT: 097 3606 583</div>", unsafe_allow_html=True)
